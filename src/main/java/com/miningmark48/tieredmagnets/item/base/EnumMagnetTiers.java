...
public enum EnumMagnetTiers {
    ...
    T1_D_MAGIC(ItemReference.MAGNET_MAGIC_DURABILITY_STONE_RL, 0, true),
    T2_D_MAGIC(ItemReference.MAGNET_MAGIC_DURABILITY_IRON_RL, 1, true),
    T3_D_MAGIC(ItemReference.MAGNET_MAGIC_DURABILITY_REDSTONE_RL, 2, true),
    T4_D_MAGIC(ItemReference.MAGNET_MAGIC_DURABILITY_GOLD_RL, 3, true),
    T5_D_MAGIC(ItemReference.MAGNET_MAGIC_DURABILITY_OBSIDIAN_RL, 4, true),
    T6_D_MAGIC(ItemReference.MAGNET_MAGIC_DURABILITY_LAPIS_RL, 5, true),
    T7_D_MAGIC(ItemReference.MAGNET_MAGIC_DURABILITY_DIAMOND_RL, 6, true),
    T8_D_MAGIC(ItemReference.MAGNET_MAGIC_DURABILITY_EMERALD_RL, 7, true),
    ...
    T1_E_MAGIC(ItemReference.MAGNET_MAGIC_ENERGY_LEADSTONE_RL, 0, true),
    T2_E_MAGIC(ItemReference.MAGNET_MAGIC_ENERGY_HARDENED_RL, 1, true),
    T3_E_MAGIC(ItemReference.MAGNET_MAGIC_ENERGY_REINFORCED_RL, 2, true),
    T4_E_MAGIC(ItemReference.MAGNET_MAGIC_ENERGY_SIGNALUM_RL, 3, true),
    T5_E_MAGIC(ItemReference.MAGNET_MAGIC_ENERGY_RESONANT_RL, 4, true),
