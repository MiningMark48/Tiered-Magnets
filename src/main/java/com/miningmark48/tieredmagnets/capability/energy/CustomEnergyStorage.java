...
public abstract class CustomEnergyStorage implements IEnergyStorage {
    ...
    public CustomEnergyStorage(IntSupplier capacitySupplier, IntSupplier extractSupplier, IntSupplier receiveSupplier) {
    ...
    public CustomEnergyStorage(IntSupplier capacitySupplier, IntSupplier transfer) {
        this(capacitySupplier, transfer, transfer);
    }

    public CustomEnergyStorage(IntSupplier capacity) {
